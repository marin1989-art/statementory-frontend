...
const IMAGES = [
  { src: '/goodmorning-back.png', alt: 'Good Morning, Friends And Haters — Rückseite mit Motiv' },
  { src: '/shirt-white-front.png', alt: 'Good Morning, Friends And Haters — Vorderseite' },
];
...
export default function GoodMorningPage() {
  ...
  const handleAddToCart = () => {
    ...
    setSizeError('');
    addItem({ sync_variant_id: VARIANT_IDS[selectedSize], productName: 'Good Morning, Friends And Haters', size: selectedSize, price_cents: 3900, quantity: 1, image: '/goodmorning-back.png' });
    setAdded(true);
