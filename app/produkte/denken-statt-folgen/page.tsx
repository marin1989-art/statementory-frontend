...
const IMAGES = [
  { src: '/denken-statt-folgen-back.png', alt: 'Denken statt Folgen — Rückseite mit Motiv' },
  { src: '/shirt-black-front.png',        alt: 'Denken statt Folgen — Vorderseite' },
];
...
export default function DenkenStattFolgenPage() {
  ...
  const handleAddToCart = () => {
    ...
    setSizeError('');
    addItem({ sync_variant_id: VARIANT_IDS[selectedSize], productName: 'Denken statt Folgen', size: selectedSize, price_cents: 2900, quantity: 1, image: '/denken-statt-folgen-back.png' });
    setAdded(true);
