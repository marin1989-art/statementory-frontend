...
export default function DenkenStattFolgenPage() {
  ...
  const handleAddToCart = () => {
    ...
    setSizeError('');
    addItem({ sync_variant_id: VARIANT_IDS[selectedSize], productName: 'Denken statt Folgen', size: selectedSize, price_cents: 2900, quantity: 1, image: '/denkenstattfolgen.png' });
    setAdded(true);
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center px-12 pt-32 pb-24 max-w-xl">
          ...
          <h1 className="text-6xl font-black uppercase tracking-tight leading-[0.9] mb-8 text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-600">statt Folgen.</h1>
