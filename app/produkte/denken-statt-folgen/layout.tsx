...
export const metadata: Metadata = {
  ...
  description:
    'Statement T-Shirt "Denken statt Folgen" — politische Streetwear für kritische Köpfe. Oversized Unisex, 100% Bio-Baumwolle. 29 €.',
  alternates: {
...
const productJsonLd = {
  ...
  description:
    'Politisches Statement T-Shirt "Denken statt Folgen". Oversized Unisex-Schnitt, 100% Bio-Baumwolle.',
