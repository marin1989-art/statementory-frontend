...
const IMAGES = [
  { src: '/make-men-back.png',     alt: 'Make Men Men Again — Rückseite mit Motiv' },
  { src: '/shirt-black-front.png', alt: 'Make Men Men Again — Vorderseite' },
];
...
export default function MakeMenMenAgainPage() {
  ...
  const handleAddToCart = () => {
    ...
    setSizeError('');
    addItem({ sync_variant_id: VARIANT_IDS[selectedSize], productName: 'Make Men Men Again', size: selectedSize, price_cents: 2900, quantity: 1, image: '/make-men-back.png' });
    setAdded(true);
