...
const IMAGES = [
  { src: '/alles-ist-gut-back.png', alt: 'Alles ist gut — Rückseite mit Motiv' },
  { src: '/shirt-black-front.png',  alt: 'Alles ist gut — Vorderseite' },
];
...
export default function AllesIstGutPage() {
  ...
  const handleAddToCart = () => {
    ...
    setSizeError('');
    addItem({ sync_variant_id: VARIANT_IDS[selectedSize], productName: 'Alles ist gut', size: selectedSize, price_cents: 2900, quantity: 1, image: '/alles-ist-gut-back.png' });
    setAdded(true);
