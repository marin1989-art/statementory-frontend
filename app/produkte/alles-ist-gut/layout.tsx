...
export const metadata: Metadata = {
  ...
  description:
    'Statement T-Shirt "Alles ist gut" — gesellschaftskritische Streetwear. Oversized Unisex, 100% Bio-Baumwolle. 29 € inkl. MwSt.',
  alternates: {
...
const productJsonLd = {
  ...
  description:
    'Gesellschaftskritisches Statement T-Shirt "Alles ist gut". Oversized Unisex-Schnitt, 100% Bio-Baumwolle.',
