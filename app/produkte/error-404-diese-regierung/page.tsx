  ...
  const handleCheckout = async () => {
    ...
    try {
      const res = await fetch('https://api.statementory.shop/create-checkout-session', {
        ...
        body: JSON.stringify({
          line_items: [{ name: `Error 404 — Größe ${selectedSize}`, price_cents: 2900, quantity: 1 }],
      ...
      <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="md:sticky md:top-0 md:h-screen flex items-center justify-center bg-zinc-950 border-r border-white/5 p-12 pt-24">
          <div className="w-full max-w-md aspect-square relative overflow-hidden">
            <img src="/error.png" alt="Error 404 — T-Shirt Mockup" className="w-full h-full object-contain" />
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center px-12 pt-32 pb-24 max-w-xl">
          ...
          <h1 className="text-5xl font-black uppercase tracking-tight leading-[0.9] mb-2">Error 404 —</h1>
          <h1 className="text-5xl font-black uppercase tracking-tight leading-[0.9] mb-8 text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-600">
            Diese Regierung befindet sich derzeit außer Betrieb.
          </h1>
