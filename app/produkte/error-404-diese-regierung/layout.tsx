...
const productJsonLd = {
  ...
  description:
    'Gesellschaftskritisches Statement T-Shirt "Error 404 — Diese Regierung befindet sich derzeit außer Betrieb". Oversized Unisex, 100% Bio-Baumwolle, Siebdruck made in Germany.',
